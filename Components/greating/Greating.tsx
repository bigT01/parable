...
const Greating = ({setIsPopUp}:any) => {
    return(
        <div className="flex flex-col items-center justify-center fixed bg-blue-500 z-20 top-2/4 left-2/4 p-10 rounded-2xl text-white min-w-1/3" style={{transform: 'translate(-50%, -50%)'}}>
