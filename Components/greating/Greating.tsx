...
const Greating = ({setIsPopUp}:any) => {
    return(
        <div className="flex flex-col items-center justify-center  bg-blue-500 z-20 p-10 rounded-2xl text-white min-w-1/3" style={{transform: 'translate(-50%, -50%)', left:'50%', top:"50%", position:'fixed', backgroundColor:"rgb(59, 130, 246)"}}>
