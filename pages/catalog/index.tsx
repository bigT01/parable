                        ...
                        <nav>
                            <ul className="flex items-center">
                                ...
                                <li className="flex items-center mr-2.5">
                                    <div
                                        className={`searching flex items-center gap-1 h-full ${isSearch ? "active-search" : null}`}>
                                        <button onClick={() => setIsSearch(oldState => !oldState)}
                                            ...
                                            {!isSearch ? (
                                                ...
                                                (
                                                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M18 6L6 18M18 18L6 6" stroke="black" strokeWidth="2"
                                        ...
                                        <input type="text"
                                               className={`search_input ${isSearch ? "active-search" : null}`}/>
                                    </div>
                                </li>
                                    ...
                                    <button>
                                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke="black" strokeWidth="2" stroke-linejoin="round"/>
                                        </svg>
                                    </button>
                                </li>
                            </ul>
