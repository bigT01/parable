        ...
        <Layout>
            <div className="flex gap-16 items-start justify-between">
                ...
                <div className="flex flex-col gap-4 w-1/2" style={{marginBottom:100}}>
                    <div className="flex p-4 bg-gray-400 rounded-2xl box-border flex-col">
                        <div className="flex w-full items-center mb-5 gap-5">
                            <h3 className="text-white text-2xl font-bold mr-auto max-w-2xl">Maro</h3>
                            <div className="flex gap-2.5 ">
                                <button className="p-2 bg-white rounded-xl box-border">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.8 19.5514H19.8M4.20007 19.5514L8.56606 18.6717C8.79784 18.625 9.01065 18.5109 9.17779 18.3437L18.9515 8.56461C19.4201 8.09576 19.4197 7.33577 18.9508 6.86731L16.8803 4.79923C16.4115 4.33097 15.6519 4.33129 15.1835 4.79995L5.40884 14.58C5.24202 14.7469 5.12812 14.9593 5.08138 15.1906L4.20007 19.5514Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                </button>
                                <button className="p-2 bg-red-500 rounded-xl box-border">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex items-end justify-between gap-5">
                            <p className="font-medium text-base text-white">Если вы хотите прожить счастливую жизнь, привязывайте ее к цели, а не к людям или вещам. - Альберт Эйнштейн: Я не потерпел неудачу. Я только что нашел 10 000 способов, которые не сработают</p>
                            <button className="p-2 bg-yellow-400 rounded-xl box-border flex">
                                <span className="mr-1.5 text-white">103</span>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
